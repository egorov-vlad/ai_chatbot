...
export const staticInfo = [
  ...
  {
    "name": "howToBet",
    "message": 'Добро пожаловать в раздел аналитики! Я покажу тебе, как самостоятельно делать ставки на киберспорт. Следуй моим инструкциям и выбирай предложенные варианты. Чтобы вернуться к началу, нажми "В начало обучения". Для прогоноза от нашего AI выбери: "Хочу рекомендацию на ставки от Winbot". Начнем!!',
    "type": "button",
  ...
  {
    "name": "teamBet",
    "message": "Выбери команду из предложенного списка, чтобы сделать для тебя рекомендацию",
    "type": "button",
